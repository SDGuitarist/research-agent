...
class TestEvaluateSources:
    ...
    def mock_score_all_high(self):
        ...
        async def mock_score(query, summary, client, rate_limit_event=None, model=None, critique_guidance=None):
            return SourceScore(
...
class TestModeThresholds:
    ...
    async def test_deep_mode_thresholds(self):
        ...
        async def mock_score_high(query, summary, client, rate_limit_event=None, model=None, critique_guidance=None):
            return SourceScore(
                url=summary.url, title=summary.title,
                score=4, explanation="Good",
            )
